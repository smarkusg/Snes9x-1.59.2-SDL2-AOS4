...
#ifdef __AMIGAOS4__
#define AMIGA_VERSION "Snes9X 1.59.2 SDL2 0.3b (12.04.2024)"
	...
	if (rom_filename)
	 {
       ...
       if (loaded) {
#ifdef __AMIGAOS4__
	sprintf(String, "%s: %s", AMIGA_VERSION,Memory.ROMName);
#else
